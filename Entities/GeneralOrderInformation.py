...
class GeneralOrderInformation:
    ...
    def to_list(self):
        return {
            Values.ID: self.id,
            Values.DIRECTION: self.direction.value,
            Values.CURRENCY_PAIR_NAME: self.currency_pair_name,
            Values.INIT_PX: self.init_currency_pair_value,
            Values.INIT_VOLUME: self.init_volume,
            Values.FILL_PX: self.fill_currency_pair_value,
            Values.FILL_VOLUME: self.fill_volume,
            Values.TAGS: self.tags,
            Values.DESCRIPTIONS: self.description
        }
