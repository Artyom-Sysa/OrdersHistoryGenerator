...
'''
    ...
    Source: http://www.helsbreth.org/random/rng_mwc1616.html
'''


class IdGenerator(PseudorandomNumberGenerator):
    __mwc1616_x = 1
    __mwc1616_y = 2
    __mwc1616_a = 18000
    __mwc1616_b = 30903
    __mwc1616_carry = 0xffff

    @classmethod
    def get_next(cls):
        '''
        Generation MWC1616 pseudo random algorithm value

        :return: next pseudo random number value wich generated by MWC1616 algorithm
        '''

        cls.__mwc1616_x = cls.__mwc1616_a * (cls.__mwc1616_x & cls.__mwc1616_carry) + (cls.__mwc1616_x >> 16)
        cls.__mwc1616_y = cls.__mwc1616_b * (cls.__mwc1616_y & cls.__mwc1616_carry) + (cls.__mwc1616_y >> 16)

        return (cls.__mwc1616_x << 16) + (cls.__mwc1616_y & cls.__mwc1616_carry)
